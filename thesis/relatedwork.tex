...
%   -> type of search (e.g., enumeration, deductive, fixed pruning rules, etc).
%   -> type of spec (e.g., examples vs. formulas)
%   -> target language
%   -> components: fixed or not, etc.
...
\begin{tabular}{@{}
				l
                >{\myraggedright}
                p{\dimexpr.2\textwidth-\tabcolsep\relax}
