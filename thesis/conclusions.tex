...
In general, a good black list contains only the shortest most general patterns that rule out superfluous programs. \TODO{some concrete advice} It is a question of interest how to generate such a black list automatically.
